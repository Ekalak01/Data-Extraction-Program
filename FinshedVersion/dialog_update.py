...
class Dialog_Update(QtWidgets.QDialog):
    ...
    def __init__(self,parent=None):
        ...
        loadUi("ui/dialog_update_ui.ui",self)
...
class Dialog_Update_wb(QtWidgets.QDialog):
    
    def __init__(self,parent=None):
        
        super(Dialog_Update_wb, self).__init__(parent)
        
        self.setFixedWidth(352)
        self.setFixedHeight(274)
        loadUi("ui/dialog_update_wb_ui.ui",self)
        self.okButton.clicked.connect(self.ok_bt)
        self.cancelButton.clicked.connect(self.close_x)
        self.ok = 0
        self.cl = 0
